...
nn = Builder.instance().add(Layer(2)).add(Layer(3, Builder.RELU)).add(Layer(1, Builder.LINEAR)).compile()
...
for i in range(100):   # *
    ...
    t  = (a * b)
    o, = nn.train((a, b), (t,))
    print('train  ', (a, b), (a * b), [o], ' error ', nn.error)
for _ in range(3):
    a  = random.randint(0, 1)
    b  = random.randint(0, 1)
    o, = nn.predict((a, b))
    print('predict', (a, b), (a * b), [o])
